...
void SelectBrand::shift()
{
    ui->quickWidget->rootContext()->setContextProperty("Brand", QVariant(model));
    ui->quickWidget->setSource(QUrl("qrc:/ui/qml/Brand/BrandView.qml"));
